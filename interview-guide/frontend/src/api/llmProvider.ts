...
export const llmProviderApi = {
  ...
  getOmniConfig: () =>
    request.get<OmniConfig>('/api/llm-provider/voice/omni'),

  updateOmniConfig: (data: OmniConfigRequest) =>
    request.put<void>('/api/llm-provider/voice/omni', data),

  testOmni: () =>
    request.post<ProviderTestResult>('/api/llm-provider/voice/omni/test'),
};
