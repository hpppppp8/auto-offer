...
public class LlmProviderController {
  ...
  @GetMapping("/voice/omni")
  public Result<OmniConfigDTO> getOmniConfig() {
    return Result.success(configService.getOmniConfig());
  }

  @PutMapping("/voice/omni")
  @RateLimit(dimension = RateLimit.Dimension.GLOBAL, count = 5)
  public Result<Void> updateOmniConfig(@RequestBody OmniConfigRequest request) {
    configService.updateOmniConfig(request);
    return Result.success();
  }

  @PostMapping("/voice/omni/test")
  @RateLimit(dimension = RateLimit.Dimension.GLOBAL, count = 10)
  public Result<ProviderTestResult> testOmniConfig() {
    return Result.success(configService.testOmniConfig());
  }
}
