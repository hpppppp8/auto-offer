...
import interview.guide.modules.voiceinterview.handler.OmniVoiceInterviewWebSocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    private final OmniVoiceInterviewWebSocketHandler omniVoiceInterviewWebSocketHandler;
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        registry.addHandler(omniVoiceInterviewWebSocketHandler, "/ws/omni-voice/{sessionId}")
                .addInterceptors(new HttpSessionHandshakeInterceptor())
                .setAllowedOrigins(corsProperties.getAllowedOrigins().split(","));
    }
